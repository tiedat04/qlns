...
<head>
    ...
    <style>
        ...
        a {
            color: #764ba2; /* Màu sắc thu hút cho link */
            text-decoration: none;
            transition: color 0.3s ease;
        }

        a:hover {
            color: #667eea; /* Đổi màu khi hover */
        }
    </style>
</head>
<body>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="MaNhanVien" class="form-label">Mã Nhân Viên (Tùy chọn)</label>
                                <input type="text" class="form-control" id="MaNhanVien" name="MaNhanVien" value="{{ old('MaNhanVien') }}">
                            </div>
